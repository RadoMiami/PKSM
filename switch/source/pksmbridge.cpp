...
static bool isBDSP(u64 id)
{
    return id == 0x0100000011D90000 || id == 0x0100000011D92000;
}

static bool isLA(u64 id) 
{
    return id == 0x01001F5010DFA000;
}

static bool isSV(u64 id)
{
    return id == 0x0100A3D008C5C000 || id == 0x01008F6008C5E000;
}
